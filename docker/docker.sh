...
docker run -d -p 80:80 -p 443:443 --name trin-app --network trinventum_net --hostname trinventum-www --user 0:0 --sysctl net.ipv4.ip_unprivileged_port_start=0 trinventum-app:latest
